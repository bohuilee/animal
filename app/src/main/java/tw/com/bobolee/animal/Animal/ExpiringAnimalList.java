...
public class ExpiringAnimalList extends AnimalListFragmentSample {
    ...
    public void getAnimalList(int Page) {
        ...
        Observable<ApiResponse<ArrayList<Animal>>> observable = animalApiAdapter.getAnimalList("Expiring", Integer.toString(Page+1));
        observable
